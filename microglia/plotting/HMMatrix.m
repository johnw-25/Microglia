...
colorbar
hold on
line(axisLines,[0, 0], [0 X], 'Color', [0.8, 0.8, 0.8],'LineStyle','-','LineWidth',1);
box off
print(f,strcat(titleName,'_HeatMapRawF.png'), '-r900','-dpng');
end