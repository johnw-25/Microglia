function [final_sorted_data,excel_table] = third_best_matching(fileName, pathName)
...
% convert x3rd_caROI column  to matlab indeces
test_data.x3rd_caROI = test_data.x3rd_caROI+1;
...
excel_structure = excel_structure(~isnan([excel_structure.x3rd_caROI]));
...
for jj = 1:length(suite2p_names)
    ...
    testroi = [excel_structure(findtest).x3rd_caROI];
...
final_matched_data(:,6) = excel_table.Somma_process3;
